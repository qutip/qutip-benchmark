...
if sys.platform == "darwin":
    sproc.call(
        "/Applications/MATLAB_R2014b.app/bin/matlab -nodesktop -nosplash -r 'matlab_version; quit'",
        shell=True,
    )
    sproc.call(
        "/Applications/MATLAB_R2014b.app/bin/matlab -nodesktop -nosplash -r 'matlab_benchmarks; quit'",
        shell=True,
    )
else:
